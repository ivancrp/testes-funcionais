...
public class AnaliseHorizontaldoBalancoDVP {
	...
	public void balancoFinaceiroTest() {
		...
		navegador.findElement(By.xpath("//ion-row[4]/ion-col[3]/ion-icon[@role='img']")).click();
		navegador.manage().timeouts().implicitlyWait(6000, TimeUnit.MILLISECONDS);
	...
	public void statusAnaliseTest() throws InterruptedException {
		...
		String textStatus = navegador.findElement(By.xpath("//ion-row[4]/ion-col[2]")).getText();
