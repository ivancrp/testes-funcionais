...
public class AnaliseHorizontaldoBalancoPatrimonialStep {
	...
	public void balancoFinaceiroTest() {
		...
		navegador.findElement(By.xpath("//ion-row[3]/ion-col[3]/ion-icon[@role='img']")).click();
		navegador.manage().timeouts().implicitlyWait(6000, TimeUnit.MILLISECONDS);
		String texto = navegador
				.findElement(By.xpath("//ion-card-header[text()=' Análise Horizontal - Balanço DVP ']"))			
				.getText();
		System.out.println(texto + "NOME DA PAGINA" );		
		
		assertEquals(texto, "Análise Horizontal - Balanço DVP");
	...
	@Story(" Preenchendo o componete de texto para salvar a alteração do status da analise")
	public void statusAnaliseTest() throws InterruptedException {
		...
		String textStatus = navegador.findElement(By.xpath("//ion-row[3]/ion-col[2]")).getText();
	...
	public void marcaUmCheckboxTestEmBranco() throws InterruptedException {
		...
		// Marca um os checkbox e preenche o Parecer do Analista
		...
		//Limpa o campo Parecer do Analista
