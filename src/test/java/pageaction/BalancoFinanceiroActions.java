...
import pageobjects.BalancoFinanceiroObjects;

public class BalancoFinanceiroActions {

	static BalancoFinanceiroObjects objBalancoFinanceiro;
	

	public BalancoFinanceiroActions(WebDriver driver) {

		
		objBalancoFinanceiro = new BalancoFinanceiroObjects(driver);
	}
